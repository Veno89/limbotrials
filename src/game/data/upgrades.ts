...
export const UPGRADES: Record<UpgradeId, UpgradeDefinition> = {
  ...
  'curse-blood-price': {
    ...
    category: 'curse',
    name: 'Blood Price',
    description: '+35% damage, but lose 25% maximum health.',
    rarity: 'rare',
    maxStacks: 1,
    modifiers: [
  ...
  'curse-fevered-soul': {
    ...
    category: 'curse',
    name: 'Fevered Soul',
    description: '+28% attack speed, but lose 12% movement speed.',
    rarity: 'rare',
    maxStacks: 1,
    modifiers: [
  ...
  'curse-hollow-fortune': {
    ...
    category: 'curse',
    name: 'Hollow Fortune',
    description: '+50% soul gain, but lose 18% maximum health.',
    rarity: 'rare',
    maxStacks: 1,
    modifiers: [
      { stat: 'soulGain', mode: 'multiply', value: 1.5 },
  ...
  'curse-final-covenant': {
    ...
    category: 'curse',
    name: 'Final Covenant',
    description: '+18% critical chance and +40% critical damage, but lose 30% maximum health.',
    rarity: 'rare',
    maxStacks: 1,
    modifiers: [
