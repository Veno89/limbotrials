...
export const UPGRADES: Record<UpgradeId, UpgradeDefinition> = {
  ...
  'cinder-reliquary-area': {
    ...
    description: 'Cinder Reliquary gains +22% pulse area.',
    rarity: 'uncommon',
    maxStacks: 3,
  ...
  'cinder-reliquary-haste': {
    ...
    description: 'Cinder Reliquary cooldown is 14% shorter.',
    rarity: 'uncommon',
    maxStacks: 3,
    targetWeapon: 'cinder-reliquary',
  ...
  'cinder-reliquary-funeral-furnace': {
    ...
    description: 'Cinder Reliquary gains +65% damage and +20% area, but its cooldown is 50% longer.',
    rarity: 'rare',
    maxStacks: 1,
    targetWeapon: 'cinder-reliquary',
    weaponModifiers: [
      { stat: 'damage', mode: 'multiply', value: 1.65 },
      { stat: 'area', mode: 'multiply', value: 1.2 },
      { stat: 'cooldownMs', mode: 'multiply', value: 1.5 },
    ],
    iconTexture: 'prop-lantern',
  },
